...
class LauncherAnalyzer:
    ...
    def analyzer_rf분석1종목(self):
        """ 10분봉 데이터를 분석하여 종목별 모델 생성 및 감시대상 선정 """
        # 파일 지정
        path_실행 = os.path.join(os.getcwd(), 'analyzer_rf분석1종목.py')
    ...
    def analyzer_rf분석2공통(self):
        """ 종목별 분석 결과를 바탕으로 통합 모델 생성 """
        # 파일 지정
        path_실행 = os.path.join(os.getcwd(), 'analyzer_rf분석2공통.py')
    ...
    def analyzer_rf백테스팅(self):
        """ 분석 결과 생성된 모델을 신규 데이터에 적용하여 수익 확인 """
        # 파일 지정
        path_실행 = os.path.join(os.getcwd(), 'analyzer_rf백테스팅.py')
    ...
    def analyzer_sr종목선정(self):
        """ 지지저항 분석을 통해 종목 선정 """
        # 파일 지정
        path_실행 = os.path.join(os.getcwd(), 'analyzer_sr종목선정.py')

        # log 기록
        self.make_log(f'sr분석 종목선정 실행')
        ...
        # log 기록
        self.make_log(f'sr분석 종목선정 완료 - {s_실행결과}')

    def analyzer_sr백테스팅(self):
        """ 선정된 종목 기준으로 백테스팅 검증 """
        # 파일 지정
        path_실행 = os.path.join(os.getcwd(), 'analyzer_sr백테스팅.py')

        # log 기록
        self.make_log(f'sr분석 백테스팅 실행')
