...
class Rotator:
    def __init__(self):
        ...
        self.dic_folder['analyzer'] = {'분석1_변동성종목': dic_폴더정보['분석1종목|10_변동성종목'],
                                       '분석1_데이터셋': dic_폴더정보['분석1종목|20_데이터셋'],
                                       '분석1_모델': dic_폴더정보['분석1종목|30_모델_종목'],
                                       '분석1_성능평가': dic_폴더정보['분석1종목|40_성능평가'],
                                       '분석1_감시대상': dic_폴더정보['분석1종목|감시대상'],
                                       '분석1_감시대상모델': dic_폴더정보['분석1종목|모델_감시대상'],
                                       '분석2_상승예측': dic_폴더정보['분석2공통|10_상승예측'],
                                       '분석2_수익검증': dic_폴더정보['분석2공통|20_수익검증'],
                                       '분석2_데이터셋': dic_폴더정보['분석2공통|30_데이터셋'],
                                       '분석2_공통모델': dic_폴더정보['분석2공통|40_공통모델'],
                                       '분석2_성능평가': dic_폴더정보['분석2공통|50_성능평가']}
