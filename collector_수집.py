...
class Collector:
    ...
    def 수집_일봉(self):
        ...
        # log 기록
        self.make_log(f'### 일봉 수집 완료 - 전체 {self.n_전체항목_일봉:,}종목, '
                      f'제외 {self.li_종목코드_제외_일봉:,}종목, 수집 {self.li_종목코드_완료_일봉:,}종목 ###')
    ...
    def 수집_분봉(self):
        ...
        # log 기록
        self.make_log(f'### 분봉 수집 완료 - 전체 {self.n_전체항목_분봉:,}종목, '
                      f'제외 {self.li_종목코드_제외_분봉:,}종목, 수집 {self.li_종목코드_완료_분봉:,}종목 ###')
